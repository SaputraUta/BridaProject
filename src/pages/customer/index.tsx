...
export default function index() {
  return (
    <LayoutCustomer>
      ...
      <SearchBar />
      <PopularSearch />
      <div className="mx-[100px] mt-16 max-w-[1140px]">
        ...
        <div className="p-2 grid grid-cols-2 w-fit bg-co2 border border-black rounded-xl items-center justify-center gap-5 mt-5">
          <div className="flex gap-5 bg-red-50 p-5 rounded-xl">
            ...
            <div>
              ...
              <p>
                Lorem ipsum dolor sit amet consectetur. Lorem habitasse
                convallis quam tempor laoreet placerat vulputate. Aliquam.
              </p>
            </div>
          </div>
